...
- Read `@_build_plan/milestones/1-core-redirect-tracer/milestone-log.md` to understand what has already been built.
...
4. When complete, write a `milestone-log.md` in this folder (`_build_plan/milestones/2-colorized-output-polish/milestone-log.md`). Structure it as follows:
