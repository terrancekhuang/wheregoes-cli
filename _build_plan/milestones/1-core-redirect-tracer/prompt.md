...
- This is milestone 1 — there is no prior milestone to read.
...
4. When complete, write a `milestone-log.md` in this folder (`_build_plan/milestones/1-core-redirect-tracer/milestone-log.md`). Structure it as follows:
